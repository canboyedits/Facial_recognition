...
from deepface import DeepFace  # Fix: Ensure DeepFace is imported
    ...
    try:
        ...
        for name, embeddings in face_db.items():
            for emb in embeddings:
                ...
                if dist < min_dist and dist < 0.75:  # Fix: Increased threshold
                    min_dist = dist
                    identity = name
    ...
    while run:
        ...
        for result in results:
            ...
            for box in boxes:
                ...
                # Fix: Ensure bounding box is within frame
                h, w, _ = frame.shape
